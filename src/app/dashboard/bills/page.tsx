...
export default function BillsPage() {
  ...
  return (
    <div className="w-[95%] md:w-[90%] mx-auto">
      ...
      <div className="flex flex-col md:flex-row lg:flex-col gap-4 mb-8">
        {/* Total Bills */}
        <div className="bg-grey-900 py-6 px-5 rounded-xl flex items-center gap-6 text-white">
          <ReceiptText />
          <div>
      ...
      <div className="bg-white rounded-xl py-6">
        <div className="w-[90%] mx-auto">
          <div className="flex items-center gap-4 md:gap-6 justify-between mb-8">
            <div className="flex-[90%] md:flex-[70%]">
              <SearchBar
                type="bill"
                onSearch={handleSearch}
              />
            </div>
            <div className="flex items-center justify-end gap-6 flex-[10%] md:flex-[30%]">
